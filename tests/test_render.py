import pytest
from termtint.render import render, enable_colors, disable_colors, _render_no_color
...
class TestRenderStyledText:
    ...
    def test_render_complex_log_message(self):
        ...
        message = StyledString(" Connection failed", style={
            StyleKey.FOREGROUND: Color.RED
        })
...
class TestRenderEdgeCases:
    ...
    def test_render_with_multiple_modifiers_order(self):
        ...
        s1 = StyledString("test", style={
            StyleKey.MODIFIERS: [Modifier.BOLD, Modifier.UNDERLINE]
        })
        s2 = StyledString("test", style={
            StyleKey.MODIFIERS: [Modifier.UNDERLINE, Modifier.BOLD]
        })
        result1 = render(s1)
        result2 = render(s2)
...
class TestRenderIntegration:
    ...
    def test_render_with_all_features_combined(self):
        ...
        parts.append(StyledString("Bold Red ", style={
            StyleKey.FOREGROUND: Color.RED,
            StyleKey.MODIFIERS: [Modifier.BOLD]
        }))
        
        parts.append(StyledString("Italic Blue ", style={
            StyleKey.FOREGROUND: Color.BLUE,
            StyleKey.MODIFIERS: [Modifier.ITALIC]
        }))
        
        parts.append(StyledString("Underline Green ", style={
            StyleKey.FOREGROUND: Color.GREEN,
        ...
        parts.append(StyledString("BG Yellow", style={
    ...
    def test_render_realistic_cli_output(self):
        ...
        header = StyledString("MyApp v1.0.0", style={
            StyleKey.FOREGROUND: Color.BRIGHT_CYAN,
            StyleKey.MODIFIERS: [Modifier.BOLD]
        })
        
        success_prefix = StyledString("✓ ", style={
            StyleKey.FOREGROUND: Color.BRIGHT_GREEN
        })
        success_msg = StyledString("Build completed successfully")
        
        warning_prefix = StyledString("⚠ ", style={
            StyleKey.FOREGROUND: Color.BRIGHT_YELLOW
        })
        warning_msg = StyledString("3 warnings found")
        
        error_prefix = StyledString("✗ ", style={
            StyleKey.FOREGROUND: Color.BRIGHT_RED,
            StyleKey.MODIFIERS: [Modifier.BOLD]
        })
        error_msg = StyledString("File not found: config.json", style={
            StyleKey.FOREGROUND: Color.RED
        })
        ...
        output = (
            header + StyledString("\n\n") +
            success_prefix + success_msg + StyledString("\n") +
            warning_prefix + warning_msg + StyledString("\n") +

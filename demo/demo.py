...
def print_color_table():
    ...
    for color in standard_colors:
        ...
        styled = StyledString(sample_text, style={StyleKey.FOREGROUND: color})

        label = StyledString(
            color_name, style={StyleKey.FOREGROUND: Color.BRIGHT_BLACK}
        )
    ...
    for color in all_colors:
        ...
        fg_color = (
            Color.BLACK
            if "WHITE" in color.name or "BRIGHT" in color.name
            else Color.WHITE
        )

        styled = StyledString(
            sample_text,
            style={StyleKey.FOREGROUND: fg_color, StyleKey.BACKGROUND: color},
        )
...
def print_modifier_table():
    ...
    for modifier in modifiers:
        ...
        styled = StyledString(
            sample_text,
            style={StyleKey.FOREGROUND: Color.CYAN, StyleKey.MODIFIERS: [modifier]},
        )

        label = StyledString(
            modifier_name, style={StyleKey.FOREGROUND: Color.BRIGHT_BLACK}
        )
...
def print_combination_examples():
    ...
    success_msg = StyledString(
        " Operation completed", style={StyleKey.FOREGROUND: Color.GREEN}
    )
    print(render(success_label + success_msg))

    warning_label = StyledString(
        "WARNING",
        style={
            StyleKey.FOREGROUND: Color.BLACK,
    ...
    warning_msg = StyledString(
        " Low disk space", style={StyleKey.FOREGROUND: Color.YELLOW}
    )
    print(render(warning_label + warning_msg))

    info_label = StyledString(
        "INFO",
        style={
            StyleKey.FOREGROUND: Color.WHITE,
    ...
    info_msg = StyledString(
        " Loading configuration...", style={StyleKey.FOREGROUND: Color.CYAN}
    )
    ...
    rainbow = (
        ...
        + StyledString(
            "O",
            style={
                StyleKey.FOREGROUND: Color.MAGENTA,
                StyleKey.MODIFIERS: [Modifier.BOLD],
            },
        )
        + StyledString(
...
def main():
    ...
    title_text = StyledString(
        "║    TermTint Demo Application    ║",
        style={
            StyleKey.FOREGROUND: Color.BRIGHT_CYAN,
            StyleKey.MODIFIERS: [Modifier.BOLD],
        },
    )
    title_bottom = StyledString(
        "╚═════════════════════════════════╝",
        style={
            StyleKey.FOREGROUND: Color.BRIGHT_CYAN,
            StyleKey.MODIFIERS: [Modifier.BOLD],
